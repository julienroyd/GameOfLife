...
class BOARDcreator(QtWidgets.QWidget):
    ...
    def setupGUI(self):
        ...
        self.SaveBtn.setStyleSheet("background-color: rgba(168, 237, 99,200); color: black; font-size: 32px; font: bold")
        self.SaveBtn.clicked.connect(self.saveBOARD)
        ...
        self.IncreaseSizeBtn.setStyleSheet("background-color: gray; color: black; font-size: 16px; font: bold")
        ...
        self.DecreaseSizeBtn.setStyleSheet("background-color: gray; color: black; font-size: 16px; font: bold")
    ...
    def getPos(self , event):
        ...
        print("Click coordinates : ({0} ; {1})".format(x,y))
    ...
    def checkAllowedSizes(self):
        if self.currentSize == len(self.listOfSizes) - 1:
            ...
            self.IncreaseSizeBtn.setStyleSheet("background-color: rgba(25,25,25,200); color: black; font-size: 16px; font: bold")
        else:
            self.IncreaseSizeBtn.setEnabled(True)
            self.IncreaseSizeBtn.setStyleSheet("background-color: gray; color: black; font-size: 16px; font: bold")
        ...
        if self.currentSize == 0:
            ...
            self.DecreaseSizeBtn.setStyleSheet("background-color: rgba(25,25,25,200); color: black; font-size: 16px; font: bold")
        else:
            self.DecreaseSizeBtn.setEnabled(True)
            self.DecreaseSizeBtn.setStyleSheet("background-color: gray; color: black; font-size: 16px; font: bold")
    ...
    def saveBOARD(self):
        print("TODO")
        #np.save("NewBOARD", self.BOARD) # TODO : Get the user given name in the dialogue box
